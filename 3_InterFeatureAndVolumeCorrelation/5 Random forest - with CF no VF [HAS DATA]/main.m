...
parfor dBSRepIndex = 1:dNumBSReps+1
    ...
    % Correlation filter
    oFeatureFilter = CorrelationFilterFeatureSelector('Parameters\Feature Selector Parameters.mat');
    oFeatureFilter.SelectFeatures(oRadiomicTrainingSet, 'JournalingOn', false);
    vbRadiomicFeatureMask = oFeatureFilter.GetFeatureMask();

    oRadiomicTrainingSet = oRadiomicTrainingSet(:, vbRadiomicFeatureMask);
