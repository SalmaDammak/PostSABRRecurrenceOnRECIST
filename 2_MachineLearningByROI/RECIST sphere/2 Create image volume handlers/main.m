...
voImageVolumeHandlersSphere = LabelledFeatureExtractionImageVolumeHandler.empty(1,0);
...
for dRow = 1:height(tVUMC)
    ...
    % Make handlers
    voImageVolumeHandlersSphere(dRow) = LabelledFeatureExtractionImageVolumeHandler(...
        oImageVolume, sImageSource,...
        'GroupIds', dPatientId,...
        'SubGroupIds', uint8(1),....
        'SampleOrder', 1,...
        'UserDefinedSampleStrings', sUniquename + " Sphere",...
...
% Save the handlers
save([Experiment.GetResultsDirectory(),'\IVHs.mat'], "voImageVolumeHandlersSphere");

% Make figures for the ROIs and save them
MakeAndSaveCollages(voImageVolumeHandlersSphere, 'RECIST sphere', tVUMC.vbOutcomes)
